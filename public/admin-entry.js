(() => {
  ...
  const addAdminButton = () => {
    const actions = document.querySelector('.phase11-drawer-panel .phase11-drawer-status:last-of-type');
    ...
    button.addEventListener('click', () => { window.location.href = '/admin.html'; });
