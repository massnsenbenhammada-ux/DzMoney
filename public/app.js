...
async function showWallet() {
  ...
  main.innerHTML = `
    ...
    <section class="wallet-card">
      ...
      <p>Minimum withdrawal: <b>${formatNumber(withdrawalConfig.minimumBux)} BUX</b></p>
      <p>Withdrawal fee: <b>${formatNumber(withdrawalConfig.feeBux)} BUX</b></p>
      ...
      <div class="ton-wallet-box ${walletConnected ? "connected" : ""}">
        ...
        ${walletConnected ? `
          ...
          <button class="withdraw-button" onclick="withdraw()" ${bux < withdrawalConfig.minimumBux ? "disabled" : ""}>
            Withdraw ${((Math.floor(bux / 1000) * 1000) / withdrawalConfig.buxPerTon).toFixed(4)} TON
          </button>
        ` : `
