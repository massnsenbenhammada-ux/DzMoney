...
async function run() {
  ...
  assert.strictEqual(
    (
      await request({
        attemptId: 1,
        userUrl: 'https://t.me/MBuxBot/app?startapp=r_8654896543',
      })
    ).status,
    401,
  );
  ...
  const result = await request(
    { attemptId: 1, userUrl: 'https://t.me/MBuxBot/app?startapp=r_8654896543' },
    auth,
  );
