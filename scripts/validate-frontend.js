...
const taskUxChecks = {
  ...
  creatorHiddenInCategory: /function renderTaskCategory\([\s\S]*?setCreatorPanelVisible\(false\)/.test(app),
  creatorVisibleOnCategoryList: /function renderTaskCategories\([\s\S]*?setCreatorPanelVisible\(false\)/.test(app)
};
