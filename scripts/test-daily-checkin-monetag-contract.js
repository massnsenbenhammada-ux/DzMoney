...
const createAdHandler = require('monetag-tg-sdk');
assert.strictEqual(typeof createAdHandler, 'function', 'Official Monetag TMA package must expose createAdHandler');
