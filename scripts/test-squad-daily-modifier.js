...
test('daily modifier is mapped from contribution, snapshots contributors, and applies only to D+1 qualifying activity', { skip: !process.env.DATABASE_URL }, async () => {
