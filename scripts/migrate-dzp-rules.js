...
async function migrate() {
  ...
  try {
    ...
    await client.query(`ALTER TABLE users ADD COLUMN IF NOT EXISTS dzp BIGINT NOT NULL DEFAULT 0;`);
    ...
    // Same schema used by daily-task-service.js; created here so the DZP trigger
    // is available before the first AdsGram confirmation.
    await client.query(`
