...
async function run() {
  ...
  require.cache[adProviderPath].exports = {
    ...
    verifyWithProvider: async () => ({
      providerId: 'monetag',
      verification: { verified: true, reference: 'monetag-ref', metadata: {} },
    }),
  };
  ...
  require.cache[dailyCheckinPath].exports = {
    ...
    finalizeDailyCheckin: async (args) => {
  ...
  const path =
    '/api/ads/monetag/postback?token=test-secret&telegram_id=123&zone_id=11627577&event_type=impression&reward_event_type=valued&estimated_price=0.01000&ymid=ymid-1&request_var=daily_checkin';
