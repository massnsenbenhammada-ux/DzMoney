...
const provider = fs.readFileSync(path.join(__dirname, '..', 'src', 'services', 'adsgram-adapter.js'), 'utf8');
...
assert.strictEqual((route.match(/router\.get\(/g) || []).length, 1, 'AdsGram Reward URL router must expose exactly one GET callback route');
