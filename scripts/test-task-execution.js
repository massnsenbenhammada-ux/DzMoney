...
async function run() {
  await expectRequired({ taskId: null, userId: 1, idempotencyKey: 'exec-1' }, 'taskId is required');
  await expectRequired({ taskId: 1, userId: null, idempotencyKey: 'exec-2' }, 'userId is required');
