...
async function createTask() {
  const result = await pool.query(
    "INSERT INTO activity_tasks (task_type,title,reward_coin,reward_dzx,reward_dzp,status) VALUES ('web','Task advertisement concurrency test',1000,1,1,'active') RETURNING id",
  );
