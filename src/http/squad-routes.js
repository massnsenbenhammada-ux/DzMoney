...
router.get('/', asyncRoute(async (req,res) => {
  ...
  return res.json({ inSquad:true, squad:{ id:squad.id,status:squad.status,memberCount:members.length,activeMemberCount:activeMembers.length,activityPercent:eligibility.explanation.activityPercent,dailyBonus:eligibility,membership } });
}));
