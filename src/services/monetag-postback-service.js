const { MONETAG_ZONE_ID, MONETAG_CONTEXT, MONETAG_VERIFICATION_CONTEXT, MONETAG_TASK_CONTEXT, MONETAG_GAMING_CONTEXT, MONETAG_SQUAD_CONTEXT } = require('../config/monetag');
...
function validateMonetagPostback(payload = {}, expectedContext = null) {
  ...
  const allowedContexts = [MONETAG_CONTEXT, MONETAG_VERIFICATION_CONTEXT, MONETAG_TASK_CONTEXT, MONETAG_GAMING_CONTEXT, MONETAG_SQUAD_CONTEXT];
...
module.exports = { MONETAG_ZONE_ID, MONETAG_CONTEXT, MONETAG_VERIFICATION_CONTEXT, MONETAG_TASK_CONTEXT, MONETAG_GAMING_CONTEXT, MONETAG_SQUAD_CONTEXT, validateMonetagPostback };
