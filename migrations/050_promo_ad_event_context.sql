-- Phase 10: Promo Codes use the shared advertisement-event source of truth.
...
ALTER TABLE activity_ad_events
  ...
  CHECK (context IN ('task', 'reward_pool', 'daily_checkin', 'verification', 'gaming', 'squad', 'promo'));
