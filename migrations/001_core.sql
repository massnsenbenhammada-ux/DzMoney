...
INSERT INTO admin_settings(key, value) VALUES
  ('economy.coin_per_dzx', '100'::jsonb),
  ('economy.dzx_per_ton', '10000'::jsonb),
  ('economy.coin_per_dzp', '1000'::jsonb),
  ('economy.dzx_per_dzp', '10'::jsonb),
  ('activity.task_reward_coin', '1000'::jsonb),
  ('activity.task_reward_dzx', '1'::jsonb),
  ('activity.task_reward_dzp', '1'::jsonb),
