...
4. pending Switch/Upgrade;
5. completed settlement.

Pending states must clearly communicate zero charge before settlement. Paid membership must not display Owner approval as a prerequisite.
